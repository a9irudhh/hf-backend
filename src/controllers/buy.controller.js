...
import PendingBorrower from "../models/pendingBorrower.model.js";
...
const createPendingRequest = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        throw new ApiError(500, `Failed to create pending request: ${error.message}`);
    }
});
...
const getPendingBorrower = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        throw new ApiError(500, `Failed to retrieve pending request: ${error.message}`);
    }
});
...
const getAllPendingRequests = asyncHandler(async (req, res) => {
    ...
    try {
      ...
      throw new ApiError(500, `Failed to retrieve pending requests: ${error.message}`);
    }
  });
